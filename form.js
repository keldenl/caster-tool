...
// function convertToId(champ_key) {
//   var return_id = "";
//   for (var key in champs_json.data) {
//       if (champs_json.data.hasOwnProperty(key)) {
//         var curr_id = champs_json.data[key].id;
//         var curr_key = key;
//         if (champ_key == curr_key) {
//           return_id = curr_id;
...
function getNames() {
  ...
  for (var i=0; i < champsList.length; i++) {
    ...
    // var curr_id = convertToId(curr_champ);
    var curr_spells = [];
    // console.log(curr_champ);
    // console.log(curr_id);
    console.log("http://ddragon.leagueoflegends.com/cdn/img/champion/loading/" + curr_champ + "_0.jpg")
    for(var j=0; j<4; j++) {
      console.log(keys[j] + ": " + spellData.data[curr_champ].spells[j].name);
...
function returnSpells() {
  ...
  console.log("complete spell data");
